...
export const useHeadHierarchy = (sector) => {
    ...
    /* ================= SUB MAJOR ================= */
    const fetchSubMajors = useCallback(async (majorHeadCode) => {
    ...
    /* ================= MINOR ================= */
    const fetchMinors = useCallback(async ({ majorHeadCode, subMajorCode }) => {
    ...
    /* ================= SUB HEAD ================= */
    const fetchSubHeads = useCallback(async ({ majorHeadCode, subMajorCode, minorHeadCode }) => {
    ...
    /* ================= SUB SUB HEAD ================= */
    const fetchSubSubHeads = useCallback(async ({ majorHeadCode, subMajorCode, minorHeadCode, subHeadCode }) => {
    ...
    /* ================= DETAIL ================= */
    const fetchDetailHeads = useCallback(async ({
        majorHeadCode,
        subMajorCode,
        minorHeadCode,
        subHeadCode,
    ...
    /* ================= SUB DETAIL ================= */
    const fetchSubDetailHeads = useCallback(async ({
        majorHeadCode,
        subMajorCode,
        minorHeadCode,
        subHeadCode,
