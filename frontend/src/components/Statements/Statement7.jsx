  ...
  return (
    <div className="w-full overflow-x-auto border-2 bg-white">
      ...
      <div className="w-full overflow-x-auto my-8">
        <table className="min-w-280 mx-auto border border-black text-[11px] text-center ">
          ...
          <tbody>
            ...
            <td colSpan={4} className="text-start px-4 py-2 text-base border">
              Total
            </td>
            <td colSpan={4} className="text-start px-4 py-2 text-base">
              {Total}
            </td>
          </tbody>
        </table>
      ...
      <div className="px-4 py-2 text-start tracking-wide">
        ...
        <p>
          <span className="">Notes:</span> Other Statements as thought
          neccessary may be proposed when the first accounts are actually
          prepared.
        </p>
      </div>
    </div>
